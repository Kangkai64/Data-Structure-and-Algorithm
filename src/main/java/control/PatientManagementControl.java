...
public class PatientManagementControl {
    ...
    public PatientManagementControl() {
        ...
        // Load data lazily to prevent hanging at startup
        // loadActivePatients();
    }
    ...
    /**
     * Ensure patient data is loaded before performing operations
     */
    ...
    // Helper: map menu choice to BloodType
    ...
    /**
     * Helper method to check if a patient's IC number matches the search criteria
     * Supports both full IC number and last 4 digits matching
     */
    private boolean hasMatchingIcNumber(String patientIcNumber, String searchIc) {
        ...
        // If search is exactly 4 digits, check if IC ends with those digits
    ...
    public String generatePatientRegistrationReport() {
        ...
        int patientCount = 0;
        int maxPatients = 1000; // Safety limit
    ...
    public String generatePatientRecordSummaryReport(String sortBy, String sortOrder) {
            ...
            public int compare(Patient a, Patient b) {
                ...
                switch (key) {
                    ...
                    case "regdate":
                        ...
                        if (da == null && db == null) result = 0; else if (da == null) result = -1; else if (db == null) result = 1; else result = da.compareTo(db);
                        break;
                    case "status":
        ...
        report.append("Sorted By: ").append(sortBy).append(" | Order: ").append(ascending ? "Ascending" : "Descending").append("\n");
        ...
        report.append(String.format("| %-12s | %-25s | %-15s | %-25s | %-12s | %-12s | %-8s | %-12s | %-33s |\n",
                "Patient ID", "Full Name", "IC Number", "Email", "Phone", "Reg Date", "Status", "Blood Type", "Allergies"));
        report.append("-".repeat(182)).append("\n");
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            String reg = p.getRegistrationDate() == null ? "N/A" : p.getRegistrationDate().format(java.time.format.DateTimeFormatter.ofPattern("dd-MM-uuuu"));
            ...
            if (allergiesOut.length() > 20) allergiesOut = allergiesOut.substring(0, 17) + "...";
    ...
    private String valueOrNA(String s) { return s == null ? "N/A" : s; }
    ...
    public String displayPatientSearchResult(Patient patient, String searchCriteria) {
        ...
        result.append("Patient ID        : ").append(patient.getPatientId() != null ? patient.getPatientId() : "N/A").append("\n");
        result.append("Full Name         : ").append(patient.getFullName() != null ? patient.getFullName() : "N/A").append("\n");
        result.append("IC Number         : ").append(patient.getICNumber() != null ? patient.getICNumber() : "N/A").append("\n");
        result.append("Email             : ").append(patient.getEmail() != null ? patient.getEmail() : "N/A").append("\n");
        result.append("Phone Number      : ").append(patient.getPhoneNumber() != null ? patient.getPhoneNumber() : "N/A").append("\n");
        result.append("Blood Type        : ").append(patient.getBloodType() != null ? patient.getBloodType().toString() : "N/A").append("\n");
        result.append("Allergies         : ").append(patient.getAllergies() != null ? patient.getAllergies() : "N/A").append("\n");
        result.append("Emergency Contact : ").append(patient.getEmergencyContact() != null ? patient.getEmergencyContact() : "N/A").append("\n");
        result.append("Registration Date : ").append(patient.getRegistrationDate() != null ? patient.getRegistrationDate().format(java.time.format.DateTimeFormatter.ofPattern("dd-MM-uuuu")) : "N/A").append("\n");
        result.append("Status            : ").append(patient.isActive() ? "Active" : "Inactive").append("\n");
        
        // Address details
        if (patient.getAddress() != null) {
            result.append("\n--- ADDRESS DETAILS ---\n");
            result.append("Street            : ").append(patient.getAddress().getStreet() != null ? patient.getAddress().getStreet() : "N/A").append("\n");
            result.append("City              : ").append(patient.getAddress().getCity() != null ? patient.getAddress().getCity() : "N/A").append("\n");
            result.append("State             : ").append(patient.getAddress().getState() != null ? patient.getAddress().getState() : "N/A").append("\n");
            result.append("Postal Code       : ").append(patient.getAddress().getZipCode() != null ? patient.getAddress().getZipCode() : "N/A").append("\n");
            result.append("Country           : ").append(patient.getAddress().getCountry() != null ? patient.getAddress().getCountry() : "N/A").append("\n");
        }
    ...
    public String displayPatientSearchResults(ArrayBucketList<String, Patient> patients, String searchCriteria) {
        ...
        result.append("Search Date: ").append(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/uuuu HH:mm"))).append("\n");
        result.append("Total Results: ").append(patients.getSize()).append(" patient(s) found\n\n");
        
        result.append("--- PATIENT LIST ---\n");
        result.append(String.format("%-12s | %-25s | %-15s | %-25s | %-15s\n", "Patient ID", "Full Name", "IC Number", "Email", "Phone Number"));
        result.append("-----------------------------------------------------------------------------------------------------\n");
